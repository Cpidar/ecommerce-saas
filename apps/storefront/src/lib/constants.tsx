...
import { getCacheTag } from "./medusa/cookies";
...
// Cache Tags
export const SUBSCRIPTIONS_CACHE_PROFILE = "subscriptions";
export const ORDERS_CACHE_PROFILE = "orders";
export const CARTS_CACHE_PROFILE = "carts";
export const PRODUCTS_CACHE_PROFILE = "products";
export const CATALOG_CACHE_PROFILE = "catalogRef";
export const STORE_CONFIG_CACHE_PROFILE = "storeConfig";
...
export const isBehpardakht = (providerId?: string) => {
  return providerId === "behpardakht";
};
