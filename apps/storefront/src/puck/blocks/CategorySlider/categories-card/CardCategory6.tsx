...
const CardCategory6: FC<CardCategory6Props> = ({
  ...
  return (
    <div
      className={`nc-CardCategory6 relative w-full aspect-w-1 aspect-h-1 h-0 rounded-3xl overflow-hidden bg-background group hover:nc-shadow-lg transition-shadow ${className}`}
    >
      <div>
