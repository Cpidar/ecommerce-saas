...
import { CustomFieldRender } from '@puckeditor/core';

type BackgroundSizeType = 'cover' | 'contain' | 'auto' | 'initial';
type BackgroundRepeatType = 'repeat-x' | 'repeat-y' | 'no-repeat' | 'repeat';
type BackgroundPositionType = 'left' | 'center' | 'top' | 'right' | 'bottom';
			...
			<div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
				...
				{/* {isBackgroundImageAllowed && (
					<ImageUploadField
						...
						onChange={(url: string) => updateValue({ backgroundImage: url })}
					...
					<div>
						...
						>
							<select
								...
								onChange={(e) =>
									updateValue({ backgroundSize: e.target.value as BackgroundSizeType })
								}
								style={{
									width: '100%',
									padding: '6px 8px',
					...
					<div>
						...
						>
							<select
								...
								onChange={(e) =>
									updateValue({ backgroundRepeat: e.target.value as BackgroundRepeatType })
								}
								style={{
									width: '100%',
									padding: '6px 8px',
					...
					<div>
						...
						>
							<select
								...
								onChange={(e) =>
									updateValue({ backgroundPosition: e.target.value as BackgroundPositionType })
								}
								style={{
									width: '100%',
									padding: '6px 8px',
